...
(function (root, factory) {
  ...
  var EXERCISES = {
    ...
    lowtrans: ex({ id: 'lowtrans', name: 'Low-Bar Transition Drill', category: 'Skill', measure: 'reps',
      ...
      alternatives: ['transition'], equipment: 'Low bar', defaults: { sets: 5, reps: 3 } }),
    transition: ex({ id: 'transition', name: 'Muscle-Up Transition Drill', category: 'Skill', measure: 'reps',
      purpose: 'Practises moving from the high-pull position to the support/dip position above the bar. It is technical practice — not a maximal strength exercise — that connects the High Pull and the Dips and supports the First Muscle-Up.',
      cues: 'Perform 2–3 clean technical sets once per week. Get the wrists over the bar fast and keep the chest high; choose a variation that matches your equipment.',
      variations: ['Low-bar, feet-assisted transition', 'Jumping transition', 'Band-assisted transition'],
      related: ['mu_lowtrans', 'mu_negmu'], alternatives: ['lowtrans', 'negmu'], equipment: 'Low bar / bar + band', defaults: { sets: 3, reps: 3 } }),
